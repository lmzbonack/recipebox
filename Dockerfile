...
#   - Ex: hexpm/elixir:1.19.5-erlang-27.3.3-debian-bullseye-20260223-slim
#
ARG ELIXIR_VERSION=1.19.5
ARG OTP_VERSION=28.3.1
ARG DEBIAN_VERSION=bookworm-20240926-slim

ARG BUILDER_IMAGE="hexpm/elixir:${ELIXIR_VERSION}-erlang-${OTP_VERSION}-debian-bookworm-20260112-slim"
